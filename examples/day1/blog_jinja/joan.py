"""
1. Orientacao Objetos para abstracao
2. mapa de roteamento de rotas 
3. Configuracao de templates
4. Objeto callable (WSGI)
5. metodo "run" execute a aplicacao
"""
...
class Joan:  # Dê o nome que quiser :) ex: `class Banana`
    def __init__(self):
        self.url_map = []
